                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                    <div class="flex justify-center items-center space-x-2">
                                        <a href="{{ route('kuesioner.pertanyaan.edit', ['kategori' => $kategori->id, 'pertanyaan' => $pertanyaan->id]) }}" wire:navigate class="p-2 rounded-md bg-yellow-500 text-white hover:bg-yellow-600">
